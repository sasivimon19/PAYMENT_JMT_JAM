...
class Call_EditData extends CI_Controller
{
    ...
    public function search_data()
    {
        ...
        if ($username == "") {
            ...
            if ($port == '') {
                $result = $this->EditData_model->select_data_withDate($T, $date);
                ...
                $result = $this->EditData_model->select_data_withPort($T, $port);
                $resultArr = array();
                ...
                $result = $this->EditData_model->select_data_withDateAndPort($T, $date, $port);
                $resultArr = array();
    ...
    public function export_data_csv()
    {
        ...
        if ($port == '') {
            $data['result'] = $this->EditData_model->select_data_withDate($T, $date);
            $this->load->view('Eir_Jmt_Finish/export/export_EditData', $data);
        } else if ($date == '') {
            $data['result'] = $this->EditData_model->select_data_withPort($T, $port);
            $this->load->view('Eir_Jmt_Finish/export/export_EditData', $data);
        } else {
            $data['result'] = $this->EditData_model->select_data_WithDateAndPort($T, $date, $port);
            $this->load->view('Eir_Jmt_Finish/export/export_EditData', $data);
        }
    }
