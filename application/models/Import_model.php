...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    class Import_model extends CI_Model {
        ...
        public function check_port($port) {
            $query = "SELECT count(*) as count_port FROM [JMTLOAN_PROD-Restore].[dbo].[tbl_PortUn] WHERE Port = '$port' ";
        ...
        $query = "INSERT INTO [JMTLOAN_PROD-Restore].[dbo].[tbl_CashFlowUn] 
    ...
    //////////////////////////////////////////////////////////////////////////////////
        public function remove_error($num, $port, $error, $name){
            $query = "UPDATE [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST]
            SET Error = '$error' 
        ...
        public function check_error(){
            $query = "SELECT * FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST] WHERE Error <> ''";
            return $this->db->query($query)->result();
        }
        ...
        public function insert_data($number, $port, $cash, $revoke, $courtFee, $transferFee, $error, $name){
            $query="INSERT INTO [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST] 
        ...
        public function select_data($name){
            $query = "SELECT * FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST]
                      WHERE Name_Import = '$name'
                      ORDER BY Port";
            return $this->db->query($query)->result();
        }
        ...
        public function edit_data($number, $port ,$cash, $revoke, $courtFee, $transferFee, $error,$name){
            $query="UPDATE [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST]
                SET  Port = '$port', Cash = '$cash', RevokeCustomer = '$revoke',
                CourtFee = '$courtFee', TransferFee = '$transferFee', Error = '$error' 
                WHERE Number = '$number' and  Name_Import = '$name'";
            return $this->db->query($query);
        }
        ...
        public function import_data_true($port, $cash, $date, $revoke, $courtFee, $transferFee) {
            $query="UPDATE [JMTLOAN_PROD-Restore].[dbo].[tbl_CashFlowUn] 
        ...
        public function select_port() {
            $query = "SELECT Port FROM [JMTLOAN_PROD-Restore].[dbo].[tbl_PortUn]
                      ORDER BY Port";
            return $this->db->query($query)->result();            
        }
        ...
        public function check_port_in_cashflow($port, $date){
            $query = "SELECT count(*) as count_data FROM [JMTLOAN_PROD-Restore].[dbo].[tbl_CashFlowUn]
        ...
        public function import_data_false($port, $cash, $date, $error, $name){
            $query="INSERT INTO [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_ERROR] 
        ...
        public function select_cash($port, $date){
            $query = "SELECT CashFlow,TransferFee, CourtFee, RevokeCustomer FROM [JMTLOAN_PROD-Restore].[dbo].[tbl_CashFlowUn]
                      WHERE Port = '$port' AND MONTH_YEAR = '$date'";
            return $this->db->query($query)->result();
        }
        ...
        public function select_import_false($name) {
            $query = "SELECT * FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_ERROR]
                      WHERE Name_Import = '$name'
                      ORDER BY Port";
            return $this->db->query($query)->result();
        }
        ...
        public function delete_import_false($name) {
            $query = "DELETE FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_ERROR]
                      WHERE Name_Import = '$name'";
            return $this->db->query($query);
        ...
        public function check_recently_updated($date_start, $date_end, $port, $date ) {
            $query = "SELECT TOP 1 [Cash_After],[Date_Update] FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMPLogUpdateCashFlow]
        ...
        public function select_recently_updated($name){
            $query = "SELECT [Port],[Recently_Cash],[Recently_Updated]  FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_TEST]
        ...
        public function count_port_error($port , $date){
            ...
            FROM [JMTLOAN_PROD-Restore].[dbo].[TBL_TMP_EIR_ERROR]
