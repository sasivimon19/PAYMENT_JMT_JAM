  ...
  <table border="1" class="table" width=60%>
    ...
    <th style="color:black; background-color: #5bc0de;">EIR</th>
      ...
      <tr style="padding-right: 1px;padding-left: 1px; text-align: center; color: #FFFFFF">
          ...
          <th style="color:black; background-color: #FFD700;">ลูกหนี้ลดลง Provision ปัจจุบัน</th>
          <th style="color:black; background-color: #FFD700;">ลูกหนี้ลดลง Provision สิ้นปี2019</th>
          ...
          <th style="color:black; background-color: #5bc0de;">Provision ผลต่าง ลูกหนี้ปลายงวดบวกดอกเบี้ยสะสมคงค้างกับ NPV</th>
          ...
          <th style="color:black; background-color: #FFD700;">Provision สะสมคงเหลือ</th>
          <th style="color:black; background-color: #FFD700;">Provision สะสมคงเหลือปี 2019</th>
          <th style="color:black; background-color: #FFD700;">Provision สะสมคงเหลือทั้งหมด</th>
