                ...
                <div class="table-space tableFixHead">
                    <table class="table table-striped table-bordered " id="table-data">
                        ...
                        <tbody>
                            <?foreach ($result as $r){?>
                                <tr>
                                    <td><?  echo iconv('tis-620//ignore','utf-8//ignore',$r->Port);?> </td>
                                    <td><?  echo iconv('tis-620//ignore','utf-8//ignore',$r->Cash);?> </td>
                                    <td><?  echo iconv("tis-620//ignore","utf-8//ignore",substr($r->Date_Import,0,11));?> </td> 
                                </tr>
