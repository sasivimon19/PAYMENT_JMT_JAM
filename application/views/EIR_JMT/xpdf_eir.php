    ...
    <?php $num = 1;
      ...
      foreach ($result as $r) { 
        ...
        <tr align="center" style="background: #FFFFFF;">
          ...
          <td nowrap style="text-align:right;"><?php echo number_format($r->Bcost,2)  ?></td>
          <td nowrap style="text-align:right;"><?php echo number_format($r->EIR,5)  ?></td>
          <td nowrap style="text-align:center;"> <? echo (new DateTime($r->MONTH_YEAR))->format("d/m/Y"); ?> &nbsp;</td>
