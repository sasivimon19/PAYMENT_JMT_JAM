                        ...
                        <div class="container-fluid">
                            <div class="card card-secondary">
                                <div class="card-header" style="background-color: #c3000d;">
                                    <h3 class="card-title"> <b> EditData </b> </h3>
                                </div>
                                <div class="card-body">   
                                    <div class="container text-center" style="margin-top:40px;margin-left:180px;">
                                        ...
                                        <div class="row" style="margin-bottom:-70px;margin-top:150px" id="att_table">
                                            ...
                                            <div  style="margin-top:0;margin-bottom:-100px;margin-left:580px">
                                               <button class="btn btn-success" onclick="export_data_csv()">Excel</button> 
                                            </div>
                                            
                                       
                                            <div class="form-group col-md-2" style="margin-top:0;margin-bottom:-100px;margin-left:700px">
                                        ...
                                        <div class="table-space tableFixHead" id="table"  style=" margin-top: 10%; margin-left: -15%">
