                                ...
                                <div class="container">
                                    ...
                                    <div class="d-flex flex-row" id="element_table">
                                        ...
                                        <div class="col-7 d-flex flex-row justify-content-center" id="att_table">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="datepicker" placeholder="วันที่รับเงิน" style="width:30%" disabled />&nbsp;&nbsp;&nbsp;

                                            <button class="btn btn-primary" id="BtnImport" onclick="import_data()" disabled>Import</button>
                                            &nbsp;&nbsp;&nbsp; <button class="btn btn-danger" id="BtnDeleteSelected" style="width:max-content;" onclick="delete_selected_data()" disabled>Delete Selected</button>
                                        </div>
                                        ...
                                        <div class="col-4 d-flex flex-row justify-content-end" style="margin-bottom:-20px;margin-left:-65px;">
                                            ...
                                            &nbsp;&nbsp;&nbsp;<select name="data_select" id="data_select" class="form-control" onchange="select_Data_Show()" disabled>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header" style="background-color: #E5E7E9">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group-prepend" style=" margin-left:60%">
                                                            <button class="btn btn-primary" id="SumNetCashReceive"> Sum NetCashReceive </button> &nbsp; &nbsp;
                                                    ...
                                                    <table class="table table-hover" id="table-data">
                                                        <thead>
                                                            <tr id="table-head">
                                                                ...
                                                                <th class="text-center" width="1%">Adjust</th>
                                                                <th class="text-center" width="1%">Commission</th>
                                                                <th class="text-center" width="1%">NetCashReceive</th>
                                                                <!-- -------------------------------------------------- -->
                                                ...
                                                <form method="post" id="user_form_edit">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <br />
                                                            <label>Enter Adjust</label>
                                                            <input type="text" name="Adjust_edit" id="Adjust_edit" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <label>Enter Commission</label>
                                                            <input type="text" name="Commission_edit" id="Commission_edit" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <label>Enter NetCashReceive</label>
                                                            <input type="text" name="NetCashReceive_edit" id="NetCashReceive_edit" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <!-- ---------------------------------------------------------------------------------- -->
                                                        </div>
                                        ...
                                        <!-- ////////////////////////////////////////////////////////////////// -->
                                        <!-- ////////////////////////////////////////////////////////////////// -->
                                        <div id="userModal_Add" class="modal">
                                            <div class="modal-dialog">
                                                <form method="post" id="user_form_add">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <br />
                                                            <label>Enter Adjust</label>
                                                            <input type="text" name="Adjust_add" id="Adjust_add" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <br />
                                                            <label>Enter Commission</label>
                                                            <input type="text" name="Commission_add" id="Commission_add" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <label>Enter NetCashReceive</label>
                                                            <input type="text" name="NetCashReceive_add" id="NetCashReceive_add" class="form-control" onkeypress="javascript:return isNumber(event)" />
                                                            <br />
                                                            <!-- ---------------------------------------------------------------------------------- -->
                                                        </div>
                                                        <div class="modal-footer">
...
<script>
    ...
    function sumcash(result) {

        sum = 0;
        for (var i in result) {
            sum += parseFloat(result[i].NetCashReceive);
            // var Verdict = parseFloat(Verdict.toFixed(2));
            // number_format((float) $foo, 2, '.', '')
        }
        ttSum = sum.toFixed(2);
        $('#SumNetCashReceive').html('Sum NetCashReceive : ' + ttSum);
    }
            ...
            $('#table-body').append(
                '<tr id="' + result[i].Number + '">\
                        <td style="padding:2px;text-align:center;vertical-align:middle;height:30px;" width="1%">\
                            <input type="checkbox" id="' + result[i].Port + '" onchange="SelectedTr(' + "'" + result[i].Number + "','" + result[i].Port + "'" + ')">\
                        </td>\
                        ...
                        <td style="padding:2px;text-align:right;vertical-align:middle;height:30px;" width="1%">' + numberTwoDecPoint(result[i].Adjust, true) + '</td>\
                        <td style="padding:2px;text-align:right;vertical-align:middle;height:30px;" width="1%">' + numberTwoDecPoint(result[i].Commission, true) + '</td>\
                        <td style="padding:2px;text-align:right;vertical-align:middle;height:30px;" width="1%">' + numberTwoDecPoint(result[i].NetCashReceive, true) + '</td>\
                    ...
                    ('<i class="fas fa-check icon-success"></i>')) + '\
                        ...
                        <td width="1%" style="padding:2px;text-align:center;vertical-align:middle;height:30px;">\
                            <button\
                                ...
                                id="' + result[i].Number + '"\
                                onclick="delete_data(' + "'" + result[i].Port + "'" + ')"\
                            >Delete</button>\
                    </tr>');
            if (result[i].Error != "") {
    ...
    function import_false() {
        ...
        $('#element_table').append(
            ...
            <div class="col-6 d-flex flex-row justify-content-center" id="att_table">\
               ...
               <button\
                ...
                >ข้อมูลที่ไม่สามารถอิมพอร์ตได้</button></div>\
                <button\
                    class="btn btn-warning "\
                    id="deleteAllPortRecently"\
                    style="margin-right:-100px"\
                    onclick="deleteAll_import_recently()"\
                    > ข้อมูลที่มีการอิมพอร์ตไปเเล้ว </button>\
                </div>\
                <div class="col-3 d-flex flex-row justify-content-end" style="margin-right: 50%">\
    ...
    function SelectedTr(Number, port) {

        const result = DeleteArr.filter(checked => checked.Number == Number);
        console.log(result);
        const obj = {
            Number: Number,
            Port: port
    ...
    $(document).on('submit', '#user_form_edit', function(event) {
        ...
        var Adjust = document.getElementById('Adjust_edit').value;
        var Commission = document.getElementById('Commission_edit').value;
        var NetCashReceive = document.getElementById('NetCashReceive_edit').value;
            ...
            for (var i in recent) {
                for (x = 0; x < tr.length; x++) {
                    if (recent[i].Port == tr[x].childNodes[4].innerText) {
                        ...
                        <button class="btn btn-info btn-xs"\ onclick="updated_detail(' + "'" +
                            numberTwoDecPoint(recent[i].Recently_Cash, true) + "',\
                        '" + recent[i].Recently_Updated + "'" + ')"\
                        >View</button>\
                        <button class="btn btn-danger btn-xs"\ onclick="delete_import_recently(' + "'" +
                            recent[i].Port + "'" + ')"\
                        >Delete</button>\
                        <span style="display:inline-flex;margin-left: 0px;">\
                        <input type="checkbox" class="" id="C' + i + '" \
                        onclick="chekedImport(' + "'" + recent[i].Port + "'" + ')">&nbsp;\
                        <label class="" for="C' + i + '"> ยืนยันการอัพเดต</label>\
                        </span>\
                        </td>';
        ...
        for (var i in port) {
            for (x = 0; x < tr.length; x++)
                if (port[i].Port == tr[x].childNodes[4].innerText) {
                    ...
                    DataTrue = DataTrue.filter(function(value) {
                        return value != port[i].Port
                    });
    ...
    function chekedImport(port) {
        ...
        if (result.length == 0) {
            ...
            CheckedArr = CheckedArr.filter(function(value) {
                return value != port
            });
        }
        CheckedArr.sort();
    ...
    function deleteTrError(port) {
        ...
        PortErr = PortErr.filter(function(value) {
            return value != port
        });
    }
    ...
    function deleteTrRecently(port) {
        ...
        PortRecent = PortRecent.filter(function(value) {
            return value != port
        });
    }
            ...
            .then((willEdit) => {
                if (willEdit) {
                    ...
                    $.ajax({
                        ...
                        .done(function(data) {
                            $("#table-body [bgcolor='PeachPuff']").remove();
    ...
    function import_data() {
        ...
        if (hasImported) {
            swal({
                    title: "ต้องการอิมพอร์ตข้อมูลนี้หรือไม่1",
                    buttons: true,
                    dangerMode: false,
                })
                .then((willEdit) => {
                        ...
                        if ((checkedall || (count_checkbox == countCheckedCheckboxes)) && (count_checkbox != 0)) {
                            ...
                            $.ajax({
                                    ...
                                    data: {
                                        date_start: date_start,
                                        date_end: date_end,
                                        isChecked: (countCheckedCheckboxes != 0),
                                        portChecked: CheckedArr
                                    }
                                })
                                .done(function(json) {
                                    swal("อิมพอร์ตข้อมูลสำเร็จ", "", "success").then(function() {
                                    ...
                                    $.ajax({
                                        ...
                                        .done(function(json) {
                                            ...
                                            if (errorStatus && hasUpdated) {
                                                ...
                                                swal("อิมพอร์ตข้อมูลสำเร็จ555", "", "success").then(function() {
                                                    document.getElementById("spinner").style.display = "block";
                                                    setInterval(location.reload(), 1500);
                                                });
                                                document.getElementById("spinner").style.display = "none";
    ...
    function delete_selected_data() {
        ...
        swal({
                title: "ต้องการลบข้อมูลนี้หรือไม่222",
                icon: "warning",
                buttons: true,
                dangerMode: false,
            })
    ...
    function delete_data(port, Number) {
