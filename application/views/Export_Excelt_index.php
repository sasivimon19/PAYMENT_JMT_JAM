<!DOCTYPE html>
<html>
<title>Export to Excel <?php foreach ($company as $data) { ?>
       ...
       <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
                ...
                <div class="divvv w3-animate-right" style="background-color:#FFFFFF;margin-top: 0px;">
                    <div class="row" style="width: 100%;">
                        <div class="col-sm-4" style="width: 100%;">
                            <h3 align="center" style="color: #040404;margin-bottom: 0px;margin-top: 0px;">Export to Excel</h3>
                        </div>
                    </div>
                    <hr>
        ...
        <script type="text/javascript">
            function scan() {
                ...
                if (datestart == '' | dateend == '' | lot == '' | Operator == '') {
