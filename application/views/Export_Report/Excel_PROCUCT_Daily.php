...
header("Content-Disposition: attachment; filename=\"Summary Receive Report By Operator Of Daily" . ".xls\"");
...
<body>
    <table border="0" class="table" width=50%>
        <tr>
            <td colspan="5"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="5" style="font-weight:bold; text-align: center;"> By Operator Of Daily </td>
        </tr>
        <tr>
            <td colspan="5" style="font-weight:bold; text-align: center;"> สำหรับ วันที่-เดือน-ปี(rec_date): <?php echo  date('d-m-Y', strtotime($datestartoperator)); ?></td>
        </tr>
        <tr>
            <td colspan="5"></td>
        </tr>
