...
<!--                    <li class="nav-item ">
                        ...
                        <a class="nav-link" data-widget="pushmenu" href="#">
                            <b> <?php //echo $Subject_Right . ' : ' . $name; ?> </b>
                        </a>
                    </li>-->
                </ul>
...
<!--                        <div class="nav-item has-treeview">
                        <?php //foreach ($username as $row): ?>
                            ...
                            <a class="d-block" href="<?php //echo site_url('/Payment_controller/Setting_index?id=') . $row->ID; ?>" class="nav-link"><i class="fas fa-users-cog"></i>  <b> Setting </b> </a>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                         ...
                         <?php if($Subject_Right == "SuperAdmin" || $Subject_Right == "Manager"){ ?>
                                    <li class="nav-item has-treeview">
                                <a href="#" class="nav-link">
