    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav" id="cantact_info">
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo site_url('Payment_controller/logout') ?>" style="color: red !important;"><i class="fas fa-sign-out-alt"></i> <b>LOGOUT</b></a>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if ($group_num == '') {
                        } else if ($group_num == '2' ||  $group_num != '1') { ?>
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <?php foreach ($username_menu as $row) { ?>
                                        <?php if ($row->group_num == '2' && $row->Status_report == 'R' || $group_num == '1' && $row->Status_report == 'R') { ?>
                                            <li class="nav-item">
                                                <a onclick="$('#loadding').show();" href="<?php echo site_url('Payment_controller/' . $row->link); ?>" class="nav-link">
                                                    <i class="<?php echo $row->icon; ?>"></i>
                            ...
                            <?php if ($group_num == '2' ||  $group_num != '1') { ?>
                                <li class="nav-item has-treeview">
                                    <a href="#" class="nav-link">
                                        <i class="nav-icon fas fa-copy"></i>
                                        <p>
    ...
    <script type="text/javascript">
        ...
        document.querySelector("html").addEventListener("click", function() {
            if (getCookie("login") === undefined) {
                window.location = "<//?php echo site_url('Payment_controller/logout/') ?>";
            }
        })
    </script> -->