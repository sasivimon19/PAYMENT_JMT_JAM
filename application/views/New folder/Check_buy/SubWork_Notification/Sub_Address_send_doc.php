...
<div class="row">
   <div class="col-sm-12">
        <div class="form-group">
            <label>ชื่อผู้รับเอกสาร : </label><label style="color: red">&nbsp;*</label>
            <input type="text" class="form-control form-control-sm" id="contact" name="contact" placeholder="ชื่อผู้รับเอกสาร ..." >
        </div>
    </div>
</div>
