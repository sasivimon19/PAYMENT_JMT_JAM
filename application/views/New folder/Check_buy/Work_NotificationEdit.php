                ...
                <div style="padding: 10px;">
                       ...
                       <div class="tab" id="page1">
                          <div class="card-header">
                            ...
                            <?php $this->load->view('Check_buy/SubWork_NotificationEdit/Sub_personalEdit'); ?>
                        </div>
                        <div class="tab" id="page2">
                           <div class="card-header">
                              <h3 class="card-title">ข้อมูลรถยนต์</h3>
                           </div>
                            <?php $this->load->view('Check_buy/SubWork_NotificationEdit/Sub_datacarEdit'); ?>
                        </div>
                         <div class="tab" id="page3">
                           <div class="card-header">
                              <h3 class="card-title">ที่อยู่สำหรับส่งเอกสาร</h3>
                           </div>
                            <?php $this->load->view('Check_buy/SubWork_NotificationEdit/Sub_Address_send_docEdit'); ?>
                        </div>
                     <div class="tab" id="page4">
                       <div class="card-header">
                          <h3 class="card-title">ที่อยู่กรมธรรม์</h3>
                       </div>
                        <?php $this->load->view('Check_buy/SubWork_NotificationEdit/Sub_policy_addressEdit'); ?>
                    </div>
                     <div class="tab" id="page5">
                       <div class="card-header">
                          <h3 class="card-title">รายการการชำระเงิน</h3>
                       </div>
                        <?php $this->load->view('Check_buy/SubWork_NotificationEdit/Sub_listcashEdit'); ?>
                    </div>
                    ...
                    <div style="height:25px;">
                        <div style="float:right;">
                          <button type="button" class="btnpn" id="prevBtn1" onclick="nextPrev(-1)" style="">Previous</button>
                          <button type="button" class="btnpn"id="nextBtn1" onclick="nextPrev(1)" style="background-color:#dc3545;height:35px;padding-bottom: 30px;">Next</button>
                        </div>
                    </div>
...
var StatusButton=<?=$StatusButton?>;
    ...
    function showTab(n) {
        ...
        if (n == (x.length - 1)) {
            ...
            if(StatusButton == 5 || StatusButton == 6 || StatusButton== 7 ){
