...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="input-group" >
            <input type="text" class="form-control form-control-sm" id="sum_customer_pay" name="sum_customer_pay" value="<?php echo $Insurance_price_total ?>"  readonly style="text-align:right">
        </div>
    </div>
...
<div class="row" >
  <div class="column" id="divinstallment">
    <div class="row" style=" padding-bottom: 5px;">
        ...
        <div class="col-md-3">
            เบี้ยประกันรวม (1) <!-- หลังหักส่วนลด -->
        </div>
        <div class="col-md-2">
