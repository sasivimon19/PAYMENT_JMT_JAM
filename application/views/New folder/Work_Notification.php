                  ...
                  <div id="show"></div>
                   <div class="tab" id="page1">
                      <div class="card-header">
                        ...
                        <?php $this->load->view('SubWork_Notification/Sub_personal'); ?>
                    </div> 
                    <div class="tab" id="page2">
                       <div class="card-header">
                          <h3 class="card-title">ข้อมูลรถยนต์</h3>
                       </div>
                        <?php $this->load->view('SubWork_Notification/Sub_datacar'); ?>
                    </div>
                     <div class="tab" id="page3">
                       <div class="card-header">
                          <h3 class="card-title">ที่อยู่สำหรับส่งเอกสาร</h3>
                       </div>
                        <?php $this->load->view('SubWork_Notification/Sub_Address_send_doc'); ?>
                    </div>
                     <div class="tab" id="page4">
                       <div class="card-header">
                          <h3 class="card-title">ที่อยู่กรมธรรม์</h3>
                       </div>
                        <?php $this->load->view('SubWork_Notification/Sub_policy_address'); ?>
                    </div>
                     <div class="tab" id="page5">
                       <div class="card-header">
                          <h3 class="card-title">รายการการชำระเงิน</h3>
                       </div>
                        <?php $this->load->view('SubWork_Notification/Sub_listcash'); ?>
                    </div>
