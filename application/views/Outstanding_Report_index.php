<!DOCTYPE html>
<html>
<title>Outstanding Report(Summary) <?php foreach ($company as $data) { ?>
                    ...
                    <div class="container-fluid">
                        <div class="card card-secondary">
                            <div class="card-header" style="background-color: #c3000d;">
                                <h3 class="card-title"> <b>Outstanding Report(Summary)</b> </h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                                </div>
                            </div>
                            <div class="card-body">
                                <form id="OutstandingReportSummary" method="post" action="<?php echo site_url('Payment_controller/daily_PDF') ?>" enctype="multipart/form-data" target="_blank">
                                    <div class="row" style=" margin-top: 2%;">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group mb-4">
                                                ...
                                                <input id="date" type="date" class="form-control userformsumOutstanding" name="date">
                                                <div class="input-group-prepend">
...
<script type="text/javascript">
    function scan() {
        ...
        checkvalsumOutstanding = () => {
            $(".userformsumOutstanding").each(function() {
        ...
        if (checkvalsumOutstanding() == false) {
            swal({
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('Payment_controller/OutstandingReportview') ?>",
                data: $("#OutstandingReportSummary").serialize(),
