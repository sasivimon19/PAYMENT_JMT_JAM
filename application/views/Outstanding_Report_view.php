<div align="center" style="overflow: auto;">
                        ...
                        <div class="card-header" style="background-color: #E5E7E9">
                            <div class="row">
                                <div class="col-md-7" style=" color: black;">
                                    <h3 class="card-title"><b> <i class="fas fa-edit"></i> Outstanding Report(Summary) </b></h3>
                                </div>
                                <div class="input-group-prepend" style=" margin-left:20%">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-warning btn-sm" onclick="Export_SumOutstanding()"><i class="fas fa-edit"></i> <b>Export SumOutstanding</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        function Export_SumOutstanding() {
            ...
            window.location.href = '<?php echo site_url('Export_report/Export_Summary_Outstanding?') ?>Operator=' + Operator + "&date=" + date + "&lot=" + lot;
