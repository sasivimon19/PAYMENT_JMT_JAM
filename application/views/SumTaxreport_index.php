                    ...
                    <div class="container-fluid">
                        <div class="card card-secondary">
                            <div class="card-header" style="background-color: #c3000d;">
                                <h3 class="card-title"> <b>SUMTAX REPORT</b> </h3>
                                    ...
                                    <div class="row" style=" margin-top: 1%;">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group mb-4">
                                                ...
                                                <input id="dateendsumtex" name="dateendsumtex" type="date" class="form-control userformTaxReport">
                                                <div class="input-group-prepend">
...
<script type="text/javascript">
    function scan() {
        ...
        if (checkvalTaxReport() == false) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('Payment_controller/Sumtax_report') ?>",
                data: $("#scan").serialize(),
            }).done(function(data) {
                $('#show').html(data);
