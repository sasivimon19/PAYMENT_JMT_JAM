                        ...
                        <div class="card-header" style="background-color: #E5E7E9">
                            <div class="row">
                                <div class="col-md-4" style=" color: black;">
                                    <h5 class="card-title"><b> <i class="fas fa-edit"></i>Export Tax Invoice</b></h5>
                                </div>
                                <div class="input-group-prepend" style=" margin-left:50%">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-warning btn-sm" onclick="ExporttaxInvoice()"><i class="fas fa-edit"></i> <b>Export Tax Invoice</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover" id="table-data">
                                <thead style="background-color: gray;">
                                    <tr>
                                        ...
                                        <th style="text-align: center; white-space:nowrap;">จำนวนเงินก่อน vat</th>
                                        <th style="text-align: center; white-space:nowrap;">vatamount</th>
                                        <th style="text-align: center; white-space:nowrap;">จำนวนเงิน</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;"><?php echo $key->number; ?></td>
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td style="text-align: center; font-weight: bold;"></td>
                                        <td style="text-align: center; font-weight: bold;"></td>
                                        <td style="text-align:  right; font-weight: bold;"><b><?php echo number_format($num_Amountfirstvat, 2); ?></b></td>
...
<script type="text/javascript">
    function ExporttaxInvoice() {
        ...
        window.location.href = '<?php echo site_url('Export_report/ExportTaxInvoice?') ?>Operator=' + Operator + "&lot=" + lot + "&datestart=" + datestart + "&dateend=" + dateend;
