                        ...
                        <div class="card-header" style="background-color: #E5E7E9">
                            <div class="row">
                                ...
                                <div class="input-group-prepend" style=" margin-left:25%">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-warning btn-sm" onclick="Export_Tax_Report()"><i class="fas fa-edit"></i> <b>Export Tax Report</b></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    <script type="text/javascript">
        function Export_Tax_Report() {
            ...
            window.location.href = '<?php echo site_url('Export_report/ExportTaxReport?') ?>date=' + date + "&dateend2=" + dateend2 + "&lot=" + lot + "&Operator=" + Operator;
