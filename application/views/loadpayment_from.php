...
<body style="background-color:#a6a6a6 !important;">
    <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
        <button style="text-align: right;" class="w3-bar-item w3-button w3-large" onclick="w3_close()"> &times;</button>
    ...
    <div id="main">
        <div class="form-group">
            <div style="background: linear-gradient(to left, #cc0000 50%, #ffffff 100%) !important;">
                <ul class="nav navbar-nav navbar-right">
                    <li style="margin-top: 15px;color: #ffffff !important;margin-right: 5px;">
                    ...
                    <?php foreach ($username as $row) : ?>
                        ...
                        <?php } ?>
                    <?php endforeach; ?>
                    <li style="margin-right: 10px;color: #ffffff !important;">
        ...
        <div class="divvv w3-animate-right" style="background-color:#FFFFFF !important;">
            <div class="row" style="width: 100%;">
                <div class="col-sm-4" style="width: 100%;">
                    <h3 align="center" style="color: #040404 !important ;margin-bottom: 0px;margin-top: 0px;">โหลดข้อมูลรับชำระ</h3>
                </div>
                <div class="col-sm-4">
                </div>
            </div>
            ...
            <div class="row content">
                <div class="col-sm-12">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#1">รายการที่สามารถบันทึกได้ (<span style="color: green;"><?php $num = 0;
                                                                                                                                foreach ($search_view as $row) {
                                                                                                                                    $num++;
                                                                                                                                }
                                                                                                                                echo $num; ?></span>)</a></li>
                        <li><a data-toggle="tab" href="#2">รายการที่ไม่สามารถบันทึกได้ (<span style="color: red;"><?php $num = 0;
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="1" style="overflow: auto;">
                            <div align="center" style="width: 100%;">
                                <div class="input-group" style="margin-top: 5px;margin-bottom: 5px;width: 30%;">
                                    ...
                                    <b><input style="text-align: right;background: #000000 !important;color: #F0FF03 !important;width: 100%;" id="msg" type="text" class="form-control" name="msg" value="<?php foreach ($sumamount as $key) {
                                                                                                                                                                                                                echo number_format($key->sumAmount, 2);
                                                                                                                                                                                                            }; ?>" readonly></b>
                                </div>
                            </div>
                            <table id="myTable" class="table" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);overflow: auto;font-size: 0.9em;width: 99.9%;">
                                <thead>
                                    <tr style="background-color:#040404;color: #FFFFFF !important;">
                                        <th>No</th>
                                        <th>Date</th>
                                        <th>Contract No</th>
                                        <th>IDCard</th>
                        ...
                        <div class="tab-pane" id="2" style="overflow: auto;">
                            <div align="center" style="width: 100%;">
                                <div class="input-group" style="margin-top: 5px;margin-bottom: 5px;width: 30%;">
                                    <span class="input-group-addon">ยอดรวม Amount :</span>
                                    <b><input style="text-align: right;background: #000000 !important;color: #F0FF03;width: 100%;" id="msg" type="text" class="form-control" name="msg" value="<?php foreach ($sumamount_not as $key) {
                                                                                                                                                                                                    echo number_format($key->sumAmount, 2);
                                                                                                                                                                                                }; ?>" readonly></b>
                                </div>
                            </div>
...
<!--<script type="text/javascript">
    function save(num){
        ...
        alert('ข้อมูลที่สามารถบันทึกได้ <?php $num = 0;
                                        foreach ($search_view as $row) {
                                            $num++;
                                        }
                                        echo $num; ?> รายการ | ข้อมูลที่ไม่สามารถบันทึกได้ <?php $num = 0;
                                                                                            foreach ($search_view_not as $row) {
                                                                                                $num++;
                                                                                            }
                                                                                            echo $num; ?> รายการ');
