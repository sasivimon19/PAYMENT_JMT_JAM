<!DOCTYPE html>
<html>
<title>Summary Discount Report <?php foreach ($company as $data) { ?>
            ...
            <div class="divvv w3-animate-right" style="background-color:#FFFFFF;margin-top: 0px;">
                <div class="row" style="width: 100%;">
                    <div class="col-sm-4" style="width: 100%;">
                        <h3 align="center" style="color: #040404;margin-bottom: 0px;margin-top: 0px;">Summary Discount Report</h3>
                    </div>
                </div>
                <hr>
